...
export const ATTENDANCE_STUDENT_STATS_REQUEST = "ATTENDANCE_STUDENT_STATS_REQUEST";
export const ATTENDANCE_STUDENT_STATS_SUCCESS = "ATTENDANCE_STUDENT_STATS_SUCCESS";
export const ATTENDANCE_STUDENT_STATS_FAIL = "ATTENDANCE_STUDENT_STATS_FAIL";
export const ATTENDANCE_STUDENT_STATS_RESET = "ATTENDANCE_STUDENT_STATS_RESET";